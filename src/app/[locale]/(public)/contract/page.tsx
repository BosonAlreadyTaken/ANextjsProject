...
export default async function Page() {
  const t = await getTranslations("Pages.Contract")
              ...
              [1, 2, 3, 4, 5].map((index) => {
                return (
                  <div key={index} className="flex-1 rounded-sm bg-white px-5 pb-20 pt-10 text-center">
                    <Image 
                      src={`/images/contract/img${index}.png`}
                      width={64}
                      height={64}
                      alt="img"
                      className="m-auto"
                    />
                    <div className="mb-2 mt-5 text-[18px]">{t(`it${index}Title` as 'it1Title')}</div>
                ...
                <div key={index} className="mb-2 rounded-sm bg-white p-4">
                  <div className="mb-2 flex items-center justify-start gap-2">
                    <Image 
                      ...
                      className=""
                    />
                     <div className="text-[18px]">{t(`it${index}Title` as 'it1Title')}</div>
                  </div>
                  <div className="text-[14px]">{t(`it${index}des1` as 'it1des1')}</div>
                </div>
              )
        ...
        <table className="my-2 w-full border-collapse border border-[#DEDEDF] text-[12px] text-[#49505E]">
          ...
          <tbody className="text-[12px] md:text-[14px]">
            ...
            <tr>
              ...
              <td className="border border-[#DEDEDF] p-2 text-center" colSpan={2}>{t('td2_2')}</td>
            </tr>
            <tr>
              <td className="border border-[#DEDEDF] p-2">{t('td3_1')}</td>
              <td className="border border-[#DEDEDF] p-2 text-center" colSpan={2}>{t('td3_2')}</td>
            </tr>
            <tr>
              <td className="border border-[#DEDEDF] p-2">{t('td4_1')}</td>
              <td className="border border-[#DEDEDF] p-2 text-center" colSpan={2}>{t('td4_2')}</td>
            </tr>
            <tr>
              <td className="border border-[#DEDEDF] p-2">{t('td5_1')}</td>
              <td className="border border-[#DEDEDF] p-2 text-center" colSpan={2}>{t('td5_2')}</td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td className="border border-[#DEDEDF] p-2 text-center" colSpan={2}>{t('td7_2_1') }<br />{ t('td7_2_2') }<br />{ t('td7_2_3') }<br />{ t('td7_2_4') }</td>
            </tr>
            <tr>
              <td className="border border-[#DEDEDF] p-2">{t('td8_1')}</td>
              <td className="border border-[#DEDEDF] p-2 text-center" colSpan={2}>{t('td8_2_1') }<br />{ t('td8_2_2') }<br />{ t('td8_2_3') }</td>
            </tr>
          </tbody>
        </table>
